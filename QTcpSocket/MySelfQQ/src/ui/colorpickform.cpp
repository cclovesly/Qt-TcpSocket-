    ...
    ui(new Ui::ColorPickForm)
{
    ...
    connect(ui->minpushBtn, &QPushButton::clicked,this,&ColorPickForm::doMinBtnClick);
    connect(ui->closepushBtn, &QPushButton::clicked,this,&ColorPickForm::doCloseBtnClick);
}
...
void ColorPickForm::doMinBtnClick()
{
    showMinimized();
}

void ColorPickForm::doCloseBtnClick()
{
    close();
}
